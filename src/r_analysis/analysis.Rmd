...
north_america + 
  geom_point(data=count_data_by_city, aes(x = long, y = lat, color=percent_ramen, size=ramen_count), alpha=0.6) +
...
```{r}
north_america + 
  geom_point(data=count_data_by_city, aes(x = long, y = lat, color=percent_pho, size=pho_count), alpha=0.7) +
